...
package com.github.nikyotensai.elf.instrument.spy;
...
public class ElfSpys1 {
    ...
    public static void putLocalVariable(String key, Object value) {
        ...
        try {
            doInvokeMethod(ElfSpys1.PUT_LOCAL_VARIABLE_METHOD, defaultValue, new Object[]{key, value});
        } catch (Throwable t) {
            t.printStackTrace(System.err);
        }
    }
    ...
    public static void putField(String key, Object value) {
        final Void defaultValue = null;
        try {
            doInvokeMethod(ElfSpys1.PUT_FIELD_METHOD, defaultValue, new Object[]{key, value});
        } catch (Throwable t) {
            t.printStackTrace(System.err);
        }
    }
    ...
    public static void putStaticField(String key, Object value) {
        final Void defaultValue = null;
        try {
            doInvokeMethod(ElfSpys1.PUT_STATIC_FIELD_METHOD, defaultValue, new Object[]{key, value});
        } catch (Throwable t) {
            t.printStackTrace(System.err);
        }
    }
    ...
    public static void fillStacktrace(String source, int line, Throwable e) {
        final Void defaultValue = null;
        try {
            doInvokeMethod(ElfSpys1.FILL_STACK_TRACE_METHOD, defaultValue, new Object[]{source, line, e});
        } catch (Throwable t) {
            t.printStackTrace(System.err);
        }
    }
    ...
    public static void dump(String source, int line) {
        final Void defaultValue = null;
        try {
            doInvokeMethod(ElfSpys1.DUMP_METHOD, defaultValue, new Object[]{source, line});
        } catch (Throwable t) {
            t.printStackTrace(System.err);
        }
    }
    ...
    public static void endReceive(String source, int line) {
        final Void defaultValue = null;
        try {
            doInvokeMethod(ElfSpys1.END_RECEIVE_METHOD, defaultValue, new Object[]{source, line});
        } catch (Throwable t) {
            t.printStackTrace(System.err);
        }
    }
