...
public class ElfClassloader extends URLClassLoader {
    ...
    public ElfClassloader(URL[] urls, ClassLoader classLoader) {
    ...
    protected synchronized Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
        ...
        if (name != null && (name.startsWith("sun.")
                ...
                || name.startsWith("com.github.nikyotensai.elf.instrument.spy."))) {
    ...
    /**
     * copy form {@link com.github.nikyotensai.elf.magic.classes.MagicClasses }，
     * Java11 使用反射调用{@link com.github.nikyotensai.elf.magic.classes.MagicClasses }时会出现 java.lang.ClassCircularityError: jdk/internal/reflect/MethodAccessorImpl
     */
