...
class SpelCompiler implements Opcodes {
    ...
    private Class<? extends CompiledExpression> createExpressionClass(SpelNodeImpl expressionToCompile) {
        ...
        String clazzName = "com/github/nikyotensai/elf/instrument/client/debugger/Ex" + getNextSuffix();
        ClassWriter cw = new ExpressionClassWriter();
        cw.visit(V1_5, ACC_PUBLIC, clazzName, null, "com/github/nikyotensai/elf/instrument/client/debugger/CompiledExpression", null);

        // Create default constructor
        MethodVisitor mv = cw.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
        mv.visitCode();
        mv.visitVarInsn(ALOAD, 0);
        mv.visitMethodInsn(INVOKESPECIAL, "com/github/nikyotensai/elf/instrument/client/debugger/CompiledExpression",
                "<init>", "()V", false);
        mv.visitInsn(RETURN);
        mv.visitMaxs(1, 1);
        mv.visitEnd();
        ...
        mv = cw.visitMethod(ACC_PUBLIC, "getValue",
                "(Ljava/lang/Object;Lqunar/tc/elf/instrument/client/debugger/EvaluationContext;)Ljava/lang/Object;", null,
                new String[]{"com/github/nikyotensai/elf/instrument/client/debugger/EvaluationException"});
        mv.visitCode();
