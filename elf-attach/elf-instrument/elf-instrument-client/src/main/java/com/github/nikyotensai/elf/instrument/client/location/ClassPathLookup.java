...
package com.github.nikyotensai.elf.instrument.client.location;
...
public final class ClassPathLookup {
    ...
    public ClassPathLookup(boolean useDefaultClassPath, String[] extraClassPath) {
        ...
        useDefaultClassPath = true;
        LOG.info("Warning ! Ignore useDefaultClassPath ! Always use the default Class Path ! ");
