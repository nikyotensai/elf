...
public class InstrumentInfo {
    ...
    public static final Set<String> IGNORE_CLASS = ImmutableSet.of("sun.reflect.DelegatingClassLoader", "com.github.nikyotensai.elf.instrument.agent.ElfClassloader");
